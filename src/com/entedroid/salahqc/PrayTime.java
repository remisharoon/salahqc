...
public class PrayTime {
    ...
    private double computeTime(double G, double t) {
    	System.out.println("this.getLat()  -->"+this.getLat());
...
//        double latitude = -37.823689;
        ...
        double timezone = Double.parseDouble(args[2]) ;
        
        System.out.println("args3  -->"+args[3]);
        int calcmeth = Integer.parseInt(args[3]) ;
        
        System.out.println("args4  -->"+args[4]);
        int isShafii = Integer.parseInt(args[4]) ;
...
//        prayers.setAsrJuristic(prayers.Shafii);
        prayers.setAsrJuristic(isShafii);
